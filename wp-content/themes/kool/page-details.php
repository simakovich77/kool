        ...
        <div class="row">
            <div class="col-md-8">
                <div class="product-image">
                    <img src=<?php bloginfo(template_url); echo "/images/featured/7.jpg"?> alt="">
                </div> <!-- /.product-image -->
            ...
            <div class="col-md-4 col-sm-8">
                ...
                <div class="product-item-2">
                    <div class="product-thumb">
                        <img src=<?php bloginfo(template_url); echo"/images/featured/8.jpg"?> alt="Product Title">
                    </div> <!-- /.product-thumb -->
                    <div class="product-content overlay">
                        <h5><a href="#">Name Of Shirt</a></h5>
                        <span class="tagline">Partner Name</span>
