            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="product-item-1">
                        <div class="product-thumb">
                            ...
                            <img src=<?php bloginfo(template_url); echo "/images/gallery-image-1.jpg"; ?> alt="Product Title">
                        </div> <!-- /.product-thumb -->
                ...
                <div class="col-md-5">
                    <div class="product-holder">
                        ...
                        <div class="product-item-2">
                            <div class="product-thumb">
                                <img src=<?php bloginfo(template_url); echo "/images/featured/2.jpg";?> alt="Product Title">
                            </div> <!-- /.product-thumb -->
                            <div class="product-content overlay">
                ...
                <div class="col-md-4">
                    <div class="product-item-3">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/featured/6.jpg"?> alt="">
                        </div> <!-- /.product-thumb -->
                        <div class="product-content">
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="product-item-4">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/featured/3.jpg";?> alt="Product Title">
                        </div> <!-- /.product-thumb -->
                        <div class="product-content overlay">
                            <h5><a href="#">Name Of Shirt</a></h5>
                            <span class="tagline">Partner Name</span>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="product-item-4">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/featured/4.jpg";?> alt="Product Title">
                        </div> <!-- /.product-thumb -->
                        <div class="product-content overlay">
                            <h5><a href="#">Name Of Shirt</a></h5>
                            <span class="tagline">Partner Name</span>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="ads-placemenet">
                        <img src=<?php bloginfo(template_url); echo "/images/featured/5.jpg";?> alt="">
                    </div> <!-- /.ads-placement -->
                </div> <!-- /.col-md-4 -->
            </div> <!-- /.row -->
        </div> <!-- /.container -->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/gallery-image-2.jpg";?> alt="">
                        </div> <!-- /.product-thum -->
                        <div class="product-content">
                            <h5><a href="#">Name of Shirt</a></h5>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/gallery-image-3.jpg";?> alt="">
                        </div> <!-- /.product-thum -->
                        <div class="product-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/gallery-image-4.jpg";?> alt="">
                        </div> <!-- /.product-thum -->
                        <div class="product-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img src=<?php bloginfo(template_url); echo "/images/gallery-image-5.jpg";?> alt="">
                        </div> <!-- /.product-thum -->
                        <div class="product-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="owl-demo" class="owl-carousel">
                            <div class="item"> 
                            	<a href="#"><img src=<?php bloginfo(template_url); echo "/images/tm-170x80-1.jpg";?> alt=""></a>
                          	</div>
                            <div class="item">
                                <a href="#"><img src=<?php bloginfo(template_url); echo "/images/tm-170x80-2.jpg";?> alt=""></a>
                            </div>
                            <div class="item">
                                <a href="#"><img src=<?php bloginfo(template_url); echo "/images/tm-170x80-1.jpg";?> alt=""></a>
                            </div>
